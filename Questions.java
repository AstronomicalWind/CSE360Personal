		 ...
		 public static void loadQuestionsFromFile() {
		        try (BufferedReader reader = new BufferedReader(new FileReader(FILE_PATH_OUTPUT))) {
		            ...
		            while ((line = reader.readLine()) != null) {
		                ...
		                boolean answered = Boolean.parseBoolean(reader.readLine());
		                boolean resolved = Boolean.parseBoolean(reader.readLine());

		                // Add the question to the ArrayList
		                questionList.add(new Question(id, questionText, description,number ));
		            }
		        } catch (IOException e) {
		            e.printStackTrace();
		        }
		        ...
		        public static void displayQuestions() {
		            ...
		            while (i < questionList.size()) {
		            	...
		            	System.out.println("Q#: "+question.number);
