...
public class SetupAccountPage {
    ...
    public void show(Stage primaryStage) {
        ...
        CheckBox staffRoleCheckBox = new CheckBox("Staff");
        ...
        setupButton.setOnAction(a -> {
            ...
            if (staffRoleCheckBox.isSelected()) {
        ...
        VBox layout = new VBox(10, 
                ...
                rolesLabel, userRoleCheckBox, reviewerRoleCheckBox, instructorRoleCheckBox, staffRoleCheckBox,
